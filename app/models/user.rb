...
class User < ApplicationRecord
  ...
  tu_hash = {dependent: :destroy, class_name: 'TournamentUser'}

  has_many :tournament_juries,      -> {where role: 'jury'},       tu_hash
  has_many :tournament_viewers,     -> {where role: 'viewer'},     tu_hash
  has_many :tournament_photographs, -> {where role: 'photograph'}, tu_hash
